...
from transforms import pipeline_jitter, pipeline_nojitter, pipeline_nojitter_lighter
import json
import cv2
import numpy as np
...
if __name__ == '__main__':
    ...
    # minimalist pipeline
    transform = pipeline_nojitter_lighter(image_size=IMAGE_SIZE)
    ...
    exp_name = f'r50_{IMAGE_SIZE}_bs{BATCH_SIZE}_lighter'
    ...
    trainer = pl.Trainer(
        ...
        logger=tb_logger,
        callbacks=[lr_logger],
        resume_from_checkpoint='/home/david/byol-pytorch/examples/lightning/lightning_logs/r50_320_bs32_lighter/last.ckpt'
    )
