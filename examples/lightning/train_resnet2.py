...
class SelfSupervisedLearner(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=EPOCHS, last_epoch=-1, eta_min=0.)
...
if __name__ == '__main__':
    ...
    tb_logger = pl_loggers.TensorBoardLogger(
        ...
        name='r50_instance_first',
        version='./')

    lr_logger = LearningRateMonitor(logging_interval='step')

    # load only model weights
    checkpoint = torch.load('/home/david/byol-pytorch/examples/lightning/lightning_logs/r50_instance_first/last.ckpt')
    checkpoint['optimizer_states'][0]['param_groups'][0]['lr'] = LR
    ...
    trainer = pl.Trainer(
        ...
        logger=tb_logger,
        callbacks=[lr_logger],
        # resume_from_checkpoint='/home/david/byol-pytorch/examples/lightning/lightning_logs/r50_instance_first/last.ckpt'
    )
